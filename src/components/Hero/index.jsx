...
const Hero = () => {
  ...
  useEffect(() => {
      if (!txtsRef.current) return;
      const txts = txtsRef.current.children;
    ...
    <div className="w-full md:w-1/2 px-4  ">
      <div className="herotext mx-auto max-w-[800px] ">
        ...
        <div className="home-text relative z-20">
          ...
          >
            Nothing Great is{" "}
            <span className="text-4xl font-bold text-red-500 ">BRAINSTORMED</span>
            <span className="text-4xl font-bold text-red-500 ">DESIGNED</span>
            <span className="text-4xl font-bold text-red-500 ">BUILD</span>
            <span className="text-4xl font-bold text-red-500 ">MADE</span> Alone.
          </p>
